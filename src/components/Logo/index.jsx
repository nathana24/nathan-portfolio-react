...
const LogoComponent = () => {
	...
	return (
    <svg class="icon icon__logo" aria-hidden="true" height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
    viewBox="0 0 23.631 23.631" xml:space="preserve">
      <title>Nathan Portfolio Logo</title>
      <g>
